...
##########################################################
    ...
    def addBeforeFirst(self, name, age,salary):
        new_node = Node(data = Employee(name, age, salary))
...
################################    
    def sort(self):
        ...
        def custom_sort(item):
            return (item[1]"""age""", -item[2]"""salary""")  # Sort by Age ascending, Salary descending
